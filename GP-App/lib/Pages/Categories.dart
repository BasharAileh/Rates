...
// Imports the Restaurants widget from another file.
...
class _CategoriesState extends State<Categories> {
  ...
  final List<String> imgList = [
    'images/_4chicks_logo.png',
    'images/BurgarMaker_Logo.jpeg',
    'images/FireFly_Logo.png',
    'images/MeatMoot_Logo.jpeg',
    'images/BurgarMaker_Logo.jpeg',
  ];
  ...
  GestureDetector FoodContainers() {
    ...
    return GestureDetector(
      onTap: () => OpenPage(
          const Restaurants()), // Navigates to the Restaurants page when tapped.
            ...
            Dialog.fullscreen(
              child: Column(
                ...
                children: [
                  ...
                  const Expanded(
                    child:  Center(
                      child: Text("Coming soon",style: TextStyle(fontSize: 50),),
                    ),
                  ),
                ],
              ),
...
// Education grid item.
        BulidGridContainers(Icons.build, 'Services',
            Dialog.fullscreen(
              child: Column(
                mainAxisAlignment:
                    MainAxisAlignment.center, // Center vertically
        ...
        BulidGridContainers(Icons.directions_car, 'Cars',
            Dialog.fullscreen(
              child: Column(
                mainAxisAlignment:
                    MainAxisAlignment.center, // Center vertically
        ...
        BulidGridContainers(Icons.accessibility_sharp, 'Clothes',
            Dialog.fullscreen(
              child: Column(
                mainAxisAlignment:
                    MainAxisAlignment.center, // Center vertically
  ...
  Container FoodCategoryContainer(IconData icon, String label) {
    ...
    return Container(
      ...
      height: totalHeight *
          0.16, // Sets the container height to 16% of the screen height.
